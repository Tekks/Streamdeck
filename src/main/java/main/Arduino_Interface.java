...
public class Arduino_Interface {
	...
	private static void checkIfRunning() {
    	  try {
    	    new ServerSocket(PORT,0,InetAddress.getByAddress(new byte[] {127,0,0,1}));
              ...
              JOptionPane.showMessageDialog(null, "Another Instance is Running",
					...
					if(chosenPort.openPort()) {
						...
						Thread thread = new Thread(){
							@Override public void run() {
								...
								while(true) {
									output.print(new SimpleDateFormat("HH:mm:ss").format(new Date()));
									output.flush();
									try {Thread.sleep(1000); } catch(Exception e) {}
								}
							}
    ...
    private static void createAndShowGUI() {
        ...
        trayIcon =
                new TrayIcon(createImage("/img/arduino.png", "tray icon"));
        ...
        aboutItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null,
                        ...
                        + "Version 2.0","About",JOptionPane.INFORMATION_MESSAGE);
            }
        });
